        ...
        <div>
               <nav   className="nav-extended white">
                ...
                <ul className="right">
                    {(props.auth.uid)? (
                    <li >
                    <Link style={{paddingLeft:'0px'}} to={`/profile/${props.auth.uid}`}  className="thumb-link"><i className="material-icons grey-text "><img className="nav-image" src={props.profile.profileImage} alt="profile"/></i></Link>
                    </li>
                    ):(
                    <li >
